...
var SEPARATION =50, AMOUNTX = 100, AMOUNTY = 100;
			...
			function init() {
				...
				container.classList.add('volna');
				document.getElementById("volnaBl").appendChild( container );
			...
			function render() {
				...
				for ( var ix = 0; ix < AMOUNTX; ix ++ ) {
					...
					for ( var iy = 0; iy < AMOUNTY; iy ++ ) {
						...
						particle.position.y = ( Math.sin( ( ix + count ) * 0.7 ) * 30 ) +
							( Math.sin( ( iy + count ) * 0.6 ) * 30 );
